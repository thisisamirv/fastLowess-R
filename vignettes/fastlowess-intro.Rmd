...
`fastlowess` is a high-performance R package for LOWESS (Locally Weighted
...
`fastlowess` provides significant speed improvements over standard
implementations:
...
[bench_url]: https://github.com/thisisamirv/fastLowess-R/tree/bench/benchmarks
